      ...
      <div className="mx-auto max-w-6xl px-6 py-10">
        <article className="rounded-lg border bg-card/40 p-6 sm:p-8">
          <h3 className="flex items-center gap-3 font-heading text-xl font-semibold tracking-tight sm:text-2xl">
            ...
            The boss level, unlocked
          </h3>
          <p className="mt-3 max-w-2xl text-sm text-muted-foreground">
            What you just saw was this election's shifts — votes flowing one way
            in 2026 vs 2021. There's a deeper story underneath: 42 seats where
            the same alliance has been gaining (or losing) for four cycles
            running. Patterns that survived the candidates and the campaigns.{" "}
            <Link
              to="/drifts"
