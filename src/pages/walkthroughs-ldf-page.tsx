 ...
 *
 * Built per docs/walkthroughs-publish-plan.md Phase 6.
 */
      ...
      subtitle={
        <>
          ...
          <p className="mt-3 max-w-3xl text-sm leading-relaxed text-muted-foreground">
            ...
            route-blind, and cabinet-status-blind: the press's "Sabarimala
            backlash" and "minister-targeted anti-incumbency" framings don't
            show up at the constituency level.
          </p>
          <p className="mt-2 max-w-3xl text-xs leading-relaxed text-muted-foreground/80">
            ...
            <em> less</em> in pilgrim-route ACs than in matched controls, and
            NDA share fell there too.
          </p>
        </>
      }
    >
      <PageMain className="space-y-10 py-6 pb-12">
        ...
        >
          <p>
            Voters left LDF broadly and evenly, not in concentrated wipeout
            zones. Across all 140 constituencies, LDF lost an average of{" "}
            <strong>{meanLDF.toFixed(2)}pp</strong> with a standard deviation of
            just 4.47pp. Three quarters of ACs sit in the modest-loss range (-10
            to 0pp). Only 6 ACs (4.3%) had what could be called catastrophic
            loss (worse than -15pp).
          </p>
          <p>
            LDF's standard deviation is the smallest of the three alliances (LDF
            4.47, UDF 5.65, NDA 5.04). The losing party's distribution is the
            tightest — which is the shape "broad anti-incumbency" produces, not
            the shape a "concentrated communal realignment" would produce.
          </p>
        </WalkthroughSection>
        ...
        >
          <p>
            Mean and median agree closely (-7.43 vs -7.73), so the distribution
            is essentially symmetric. The IQR — the middle 50% of ACs — spans
            just 5.80pp. The bulk of the mass sits between -12pp and -3pp.
          </p>
          <p>
            Excess kurtosis is +1.55, slightly fatter-tailed than a normal
            distribution. The outliers worth naming — Udumbanchola (-24.6pp),
            Payyannur (-17.8pp), Puthuppally (-16.8pp) on the loss side; Vengara
            (+8.5pp), Konni (+3.2pp) on the gain side — sit visibly outside the
            modal cluster. The "shallow everywhere" framing coexists with these
            specific outliers; both are true.
          </p>
        </WalkthroughSection>

        <PullQuote>
          The press's "Sabarimala backlash" and "minister-targeted
          anti-incumbency" framings each predict a concentrated collapse zone.
          The data shows neither.
        </PullQuote>
        ...
        >
          <p>
            Press framing predicted larger LDF losses in pilgrim-route ACs as
            evidence of Hindu backlash over the Sabarimala gold-cladding scandal
            and lingering 2018 anger. The data shows the opposite: the three
            geographic Sabarimala-route ACs (Aranmula, Konni, Ranni) had a
            smaller LDF loss ({routeMean.toFixed(1)}pp) than{" "}
          ...
          <p>
            ...
            Ettumanoor, Veena George / Aranmula, Kadakampally / Kazhakoottam)
            lost their own seats by ~4pp more than matched controls. That's a
            minister-incumbency penalty applied to specific high-visibility
            cabinet members, not a route-targeted geographic effect.
          </p>
        </WalkthroughSection>
        ...
        >
          <p>
            ...
            minister losses were highly visible. But on this data, ministers
            lost slightly less share than non-minister LDF incumbents (-6.89pp
            vs -7.63pp). The "minister-targeted anti-incumbency" hypothesis
            predicts a more-negative differential for ministers; the data shows
            a slightly less-negative one.
          </p>
          <p>
            The 14 ministers who lost their seats lost them because they
            happened to be sitting in the LDF column when a 7pp wave hit, not
            because voters specifically targeted cabinet members. Outsized
            individual losses concentrate among small-party LDF allies (JD(S),
            NCP, KC(M)) — that's a coalition-cohesion finding, not a
            cabinet-rejection one.
          </p>
        </WalkthroughSection>
        ...
        >
          <p>
            The "UDF surge" reads more accurately as the geographic landing
            pattern of LDF erosion. UDF gained an average of +7.29pp per AC —
            almost numerically identical to LDF's -7.43pp loss. NDA also gained
            (+2.05pp), and OTHER alliances/independents bled (-1.91pp).
          </p>
          <p>
            65% of ACs show UDF-dominant absorption (UDF received &gt;70% of
            LDF's loss). 23% show NDA-dominant absorption (concentrated in
            southern Kerala — see Arc 3). Only 3% saw LDF hold or gain.
          </p>
          <p>
            This reframe matters for 2031: an "anti-LDF wave" interpretation
            predicts that recovering LDF voters could reverse the swing in
            future cycles. A "UDF mobilisation" interpretation would predict
            more durable UDF strength. The data on this cycle is more consistent
            with the former, but a 2031 LDF recovery (or its absence) is the
            real test.
          </p>
        </WalkthroughSection>
        ...
        <TakeawayBox>
          <p>
            Kerala 2026's anti-LDF wave was real, broad, and geographically
            uniform. LDF lost ~7pp across nearly every constituency, with low
            variance and no concentrated collapse zone. The press's preferred
            targeted-mechanism framings — Sabarimala backlash, cabinet rejection
            — don't survive constituency-level testing. Most of the lost LDF
            vote landed on UDF; in southern Kerala's Hindu-heavy seats, NDA
            picked up a meaningful share too. The "anti-LDF, not pro-UDF"
            framing matters for 2031: anti-incumbency-driven votes are more
            reversible than ideologically realigned ones.
          </p>
        </TakeawayBox>
        ...
        <section className="border-t pt-8">
          ...
          <ul className="max-w-prose list-disc space-y-2 pl-6 text-sm leading-relaxed text-muted-foreground">
            <li>
              ...
              that includes additional ACs and shows a coherent LDF differential
              — would suggest the route effect is real but the 3-AC subset was
              too narrow.
            </li>
            <li>
              <strong className="font-medium text-foreground">
              ...
              showing voters in pilgrim-route ACs cited Sabarimala as a primary
              motivator at higher rates than elsewhere — would indicate a latent
              effect masked at the AC level.
            </li>
            <li>
              <strong className="font-medium text-foreground">
              ...
              in similar conditions — would suggest the +0.74pp non-detection
              here is a 2026-specific artefact.
            </li>
            <li>
              <strong className="font-medium text-foreground">
              ...
              suggest 2026 was a structural realignment rather than a transient
