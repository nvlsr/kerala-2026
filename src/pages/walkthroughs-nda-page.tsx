    ...
    >
      <PageMain className="space-y-10 py-6 pb-12">
        ...
        >
          ...
          <p className="mt-3">
            All 3 wins had NDA-2021 base ≥ 29% — already structurally near a
            winning share before the 2026 cycle. Across Kerala's 140 ACs, only 8
          ...
          <p>
            ...
            <em>more</em> of the anti-LDF redistribution than UDF did. All 3
            wins are in this set; details in the wave-capture section below.
          </p>
        </CohortSection>
        ...
        >
          ...
          <p>
            ...
            candidates Anoop Antony and Shone George); 2 Hindu-Muslim Kozhikode
            (<SeatLink ac={27}>Kozhikode North</SeatLink>,{" "}
        ...
        <section className="scroll-mt-20 border-t pt-10">
          ...
          <div className="mb-8 rounded-md border bg-card/50 p-5 sm:p-6">
            <p className="mb-4 max-w-prose text-[15px] leading-relaxed font-medium">
              ...
              seats. The flat statewide aggregate is the average of three very
              different regimes — a targeted 30-seat set where BJP grew
            ...
            <p className="mt-3 text-xs text-muted-foreground">
              Same data, three lenses. The statewide figure includes ACs where
              BJP didn't field (counts as 0%), dragging the mean toward zero.
              The paired view at 89 ACs strips that out. The targeted view zooms
              further to the 30 ACs where BJP put real effort.
            </p>
          </div>
          ...
          <p className="mt-3 max-w-prose text-sm leading-relaxed">
            BJP itself was essentially flat (+0.30pp on a base of 11.29%). NDA
            grew +2.05pp, with{" "}
            <strong>T20 the biggest mover in relative terms</strong> — a 100%
            jump on a tiny base after T20 was inducted into NDA in January 2026
            and contested 19 ACs (up from 8 in 2021). BJP + BDJS + T20 totals
            (14.51%) match the NDA aggregate (14.54%) within rounding.
          </p>
          ...
          <p className="mb-3 max-w-prose text-sm leading-relaxed text-muted-foreground">
            ...
            candidate that year. Tells you "how strong was the alliance where it
            actually contested."
          </p>
          <Table>
            <TableHeader>
          ...
          <p className="mt-3 max-w-prose text-sm leading-relaxed">
            <strong>BJP shrank footprint</strong> (115 → 98 candidates, −15%)
            but average share at the seats it did field rose from 13.74% to
            16.50%. <strong>T20's footprint more than doubled</strong> (8 → 19
            ACs); per-fielded share dropped because the new ACs are thinner
            terrain, but aggregate impact still grew.{" "}
            <strong>BDJS held footprint steady</strong> with a small per-fielded
            uptick.
          </p>
        </section>
        ...
        <section className="border-t pt-8 text-xs leading-relaxed text-muted-foreground">
          ...
          <p className="mt-3">
            ...
            JD(S), LJD, NCP small-ally allocations to LDF in 2021 are credited
            to LDF (not OTHER) via per-candidate{" "}
