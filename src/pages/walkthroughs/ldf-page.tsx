...
import { RAIL_GROUPS, SABARIMALA_ROUTE_ACS, WEAKENERS } from "./ldf-data"
    ...
    >
      <ThesisLede confidence="strong">
        <p className="text-base leading-relaxed font-medium text-foreground sm:text-[16.5px]">
          LDF lost{" "}
          <strong>~7pp of vote share across nearly every constituency</strong> —
          not in concentrated wipeout zones. Two press-favoured mechanisms
          (Sabarimala backlash, cabinet rejection){" "}
          <strong>don't survive constituency-level testing</strong>. The lost
          LDF vote landed mostly on UDF, with NDA picking up a meaningful slice
          in southern Hindu-heavy seats.
        </p>
        <p className="mt-3 text-sm leading-relaxed text-muted-foreground sm:text-[14.5px]">
          The shape of the data — broad, shallow, religion-blind, route-blind,
          cabinet-status-blind — reads more like <em>anti-incumbency</em> than{" "}
          <em>realignment</em>.{" "}
          <strong>
            Anti-incumbency-driven votes are more reversible than ideologically
            realigned ones,
          </strong>{" "}
          so LDF's recovery prospects in 2031 depend on whether the wave will be
          situational (UDF-fatigue, inflation) or structural (community-shift
          away from the Left).
        </p>
      </ThesisLede>
      ...
      >
        <p className={SECTION_LEAD}>
          <strong>The wave was broad, not deep.</strong> Voters left LDF evenly
          across the state, not in concentrated wipeout zones.
        </p>
        <p>
          ...
          to 0pp). Only 6 ACs (4.3%) had what could be called catastrophic loss
          (worse than −15pp).
        </p>
        <p>
      ...
      >
        <p className={SECTION_LEAD}>
          <strong>Tight middle, light tails.</strong> 75% of ACs lost between 0
          and 10pp; the IQR is just 5.80pp wide.
        </p>
        <p>
          Mean and median agree closely (−7.43 vs −7.73), so the distribution is
          essentially symmetric. The bulk of the mass sits between −12pp and
          −3pp.
        </p>
        <p>
          ...
          <SeatLink ac={98}>Puthuppally</SeatLink> (−16.8pp) on the loss side;{" "}
          <SeatLink ac={41}>Vengara</SeatLink> (+8.5pp),{" "}
          <SeatLink ac={114}>Konni</SeatLink> (+3.2pp) on the gain side. The
          "shallow everywhere" framing coexists with these specific outliers;
          both are true.
        </p>
      </WalkthroughSection>
      ...
      <PullQuote>
        ...
        anti-incumbency" framings each predict a concentrated collapse zone. The
        data shows neither.
      </PullQuote>
      ...
      >
        <p className={SECTION_LEAD}>
          <strong>Sabarimala backlash didn't show up in the data.</strong> The
          wrong-sign result is the hardest part for the press framing to
          explain.
        </p>
        <p>
          ...
          geographic Sabarimala-route ACs (
        ...
        <p>
          ...
          <SeatLink ac={132}>Kazhakoottam</SeatLink>) lost their own seats by
          ~4pp more than matched controls. That's a minister-incumbency penalty
          applied to specific high-visibility cabinet members, not a
          route-targeted geographic effect.
        </p>
        <p className={ASIDE}>
      ...
      >
        ...
        <p>
          ...
          minister losses were highly visible. But on this data, ministers lost
          slightly less share than non-minister LDF incumbents (−6.89pp vs
          −7.63pp).
        </p>
        <p>
          The 14 ministers who lost their seats lost them because they happened
          to be sitting in the LDF column when a 7pp wave hit, not because
          voters specifically targeted cabinet members. Outsized individual
          losses concentrate among small-party LDF allies (JD(S), NCP, KC(M)) —
          that's a coalition-cohesion finding, not a cabinet-rejection one.
        </p>
      </WalkthroughSection>
      ...
      >
        <p className={SECTION_LEAD}>
          ...
          meaningful subset (23%), NDA out-bid UDF for those voters instead.
        </p>
        <p>
          On average, UDF gained +7.29pp per AC — almost numerically identical
          to LDF's −7.43pp loss. NDA also gained (+2.05pp), and OTHER
          alliances/independents bled (−1.91pp). The statewide averages mask a
          real geographic split:
        </p>
        <p>
          65% of ACs show UDF-dominant absorption (UDF received &gt;70% of LDF's
          loss). 23% show NDA-dominant absorption — concentrated in southern
          Kerala, where BJP and UDF directly competed for the same defectors.
          See the{" "}
          <Link
          ...
          for the 21 seats where NDA out-bid. Only 3% of ACs saw LDF hold or
          gain.
        </p>
      </WalkthroughSection>
      ...
      <section className="rounded-md border bg-card/50 p-5 sm:p-6">
        ...
        <ul className="mt-3 space-y-2 text-sm leading-relaxed">
          <li>
            ...
            added a separate ~3-4pp differential on top of the wave, turning a
            normal anti-incumbency election into a 102-seat majority.
          </li>
          <li>
            In 21 seats — overwhelmingly Hindu-heavy, mostly in southern Kerala
            — NDA out-bid UDF for the defectors. See the{" "}
            <Link
              to="/walkthroughs/nda-walkthrough#wave-capture"
              className="font-medium text-foreground underline-offset-2 hover:underline"
            >
            ...
            for the wave-capture cohort and BJP's competitive frontier with UDF.
          </li>
        </ul>
      </section>
