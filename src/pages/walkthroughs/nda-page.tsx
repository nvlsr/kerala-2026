      ...
      <>
        ...
        <section className="rounded-md border bg-card/50 p-5 sm:p-6">
          <p className="text-base leading-relaxed font-medium text-foreground sm:text-[16.5px]">
            ...
            (+0.3pp), but inside a <strong>30-seat target set</strong> — about
            21% of Kerala's Assembly constituencies — BJP grew by{" "}
            <strong>+5.2pp</strong> and converted 3 seats. The party is{" "}
            <strong>trading breadth for intensity</strong>: fewer seats
            contested directly (115 → 98 candidates), higher share where it does
            contest.
          </p>
          ...
          <p className="mt-3 text-sm leading-relaxed text-muted-foreground sm:text-[14.5px]">
            ...
            <strong>mature NDA base</strong> already existed (≥29% going in). It
            produced large but non-converting jumps in low-base seats. It
            remains structurally excluded or alliance-dependent across a large
            slice of the state. The cohorts below map each of these terrains in
            detail.
          </p>
        </section>
        ...
        >
          <p className={SECTION_LEAD}>
            ...
            <SeatLink ac={126}>Chathannoor</SeatLink>. All three converged on
          ...
          <p className="mt-3">
            All 3 wins had a 2021 NDA base ≥ 29% — already structurally close to
            a winning share before the cycle started. Statewide, 8 seats had
            bases at or above that level going in (see the{" "}
          ...
          <p>
            ...
            , with a smaller slice going to NDA. At 21 specific seats, the swing
            pattern inverted — NDA absorbed <em>more</em> of the anti-LDF
            redistribution than UDF did. All 3 wins are in this set; details in
            the <CohortLink slug="wave-capture">wave-capture</CohortLink>{" "}
            section below.
          </p>
        </CohortSection>
        ...
        >
          <p className={DEFINITION}>
            Seats where BJP grew meaningfully on a mature base — either reaching
            ≥25% in 2026 with ≥+5pp gain, or sustaining ≥+2pp growth across both
            2016→2021 and 2021→2026 (trajectory). 11 unique seats, sorted by
            2026 BJP share. <span className="not-italic">★</span> marks the 4
            seats that also satisfy the multi-cycle trajectory criterion.
          </p>
          <p>
            This is the clearest set where BJP expanded from a meaningful base —
            the closest 8 ACs to a winning structural position, plus 3
            trajectory seats showing two-cycle build. If BJP is going to convert{" "}
            <em>more than 3 seats</em> next cycle, the most likely candidates
            sit inside this cohort.
          </p>
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead className={COMPACT_HEAD_CLASS}>Seat</TableHead>
                <TableHead className={COMPACT_HEAD_CLASS}>District</TableHead>
                ...
                <TableHead className={COMPACT_HEAD_CLASS}>Outcome</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {MATURE_GROWER_ROWS.map((r) => (
                <TableRow
                  key={r.ac}
                  className={r.outcome === "BJP WIN" ? HIGHLIGHT_ROW_CLASS : ""}
                >
                  <TableCell className={COMPACT_CELL_CLASS}>
          ...
          <p className="mt-3">
            Chathannoor is the only sustained-trajectory seat that converted to
            a 2026 win.
          </p>

          <h3 className={SUB_HEADING}>A practical conversion threshold?</h3>
          <p>
            The data is consistent with a practical conversion threshold near
            the high-20s in this cycle. The 3 wins all entered with NDA-2021
            base ≥ 29%. The largest single-cycle Δ in the cohort —{" "}
            <SeatLink ac={93}>Pala</SeatLink> at +18.2pp — didn't convert
            because the base was 7.9%. <SeatLink ac={111}>Thiruvalla</SeatLink>{" "}
            (+14.5pp) ended at 30.7% but started from 16.2% and lost too.{" "}
            <strong>
          ...
          <p className={ASIDE}>
            With n=3 wins this is suggestive, not proven. The threshold could
            move next cycle if other factors shift; what's robust is the pattern
            that base + meaningful Δ converted, while large Δ from a low base
            did not.
          </p>
        </CohortSection>
        ...
        >
          ...
          <p>
            ...
            seats where BJP <em>had</em> a mature base (≥20%) and lost it. Tells
          ...
          <p className="mt-3">
            ...
            seats sit on Christian-mixed terrain. The pattern is consistent with
            BJP needing either a <em>marquee Christian candidate</em> (see Pala
            and Thiruvalla in{" "}
            <CohortLink slug="mature-growers">mature growers</CohortLink>) or an{" "}
            <em>alliance swap</em> (Konni's BDJS slot in 2026) to make progress
            in this terrain. Marquee alone isn't a guarantee — both Thrissur
            (Padmaja Venugopal) and Poonjar (P.C. George) declined despite
            high-profile candidates. With BJP's marquee Christian roster thin,
            alliance swaps are the more scalable fallback. The broader pattern
            of Christian-belt vote movement is documented in the{" "}
        ...
        >
          ...
          <p>
            This may be the clearest window into BJP's competitive terrain. It
            isolates the seats where NDA out-captured UDF in the redistribution
            of LDF voters — the ~15% of Kerala where the{" "}
            <ProseLink to="/walkthroughs/ldf-walkthrough">
              anti-LDF wave
            </ProseLink>{" "}
          ...
          <p className="mt-3">
            <strong>BJP's competitive frontier with UDF.</strong> This is the
            only cohort where BJP and UDF directly compete for the same swing
            voters — anti-LDF defectors that both alliances bid for. NDA out-bid
            UDF here; the 3 BJP wins concentrate in this set. Direct BJP-vs-UDF
            competition at this scale (21 seats) is a new structural feature of
            Kerala politics — earlier cycles had isolated BJP-competitive seats,
            not a contiguous cohort.
          </p>
          <p>
            <strong>
            ...
            itself. These contests matter disproportionately under FPTP, because
            they're the only seats where NDA's ceiling is "win" rather than
            "second place." Concentrated growth here converts to seats;
            equivalent growth spread across structurally weak terrain wouldn't.
          </p>
          <p>
            <strong>A strategic study set for 2031.</strong> UDF is likely to
            defend these seats more aggressively next cycle, having lost the
            absorption competition in 2026. BJP's positioning and execution from
            these specific wins becomes the playbook against which 2031 contests
            are measured.
          </p>
        </CohortSection>
        ...
        >
          ...
          <p>
            ...
            NDA's vote share is stuck in the single digits — too low to threaten
            a seat under FPTP. Contrasts with{" "}
            <CohortLink slug="strategic-abstention">
              strategic abstention
            </CohortLink>
            , where a viable ceiling does exist (10-15% via BDJS or T20) but BJP
            chooses not to compete directly.
          </p>
          <Table>
            <TableHeader>
              <TableRow>
        ...
        >
          ...
          <p className={cn(SECTION_LEAD, "mb-6 max-w-prose")}>
            The statewide BJP figure (+0.3pp) looks almost flat. But that single
            number averages together three very different terrains: a 30-seat
            target universe where BJP grew strongly, a neutral middle where
            movement was limited, and an abstention-or- exclusion set where BJP
            either declined or didn't field. The right question isn't "how much
            did BJP grow statewide?" but "where did BJP choose to compete, and
            what happened there?"
          </p>
          ...
          <p className="mb-3 max-w-prose text-sm leading-relaxed">
            The same election produces three very different stories depending on
            the lens used. Read top-to-bottom, each lens strips away seats where
            BJP either didn't compete or was structurally weak.
          </p>
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead className={COMPACT_HEAD_CLASS}>Lens</TableHead>
                <TableHead className={COMPACT_HEAD_CLASS}>Meaning</TableHead>
                <TableHead className={cn(COMPACT_HEAD_CLASS, NUM_HEAD_CLASS)}>
                  n
                </TableHead>
                <TableHead className={cn(COMPACT_HEAD_CLASS, NUM_HEAD_CLASS)}>
            ...
            <TableBody>
              {THREE_LENSES.map((r, i) => (
                ...
                >
                  <TableCell className={cn(COMPACT_CELL_CLASS, "font-medium")}>
                    {r.lens}
                  </TableCell>
                  <TableCell
                    className={cn(
          ...
          <p className="mb-3 max-w-prose text-base leading-relaxed font-medium text-foreground sm:text-[15.5px]">
            BJP shrank its footprint while raising per-seat share — fewer seats
            contested directly, higher share where contested.
          </p>
          <Table>
            <TableHeader>
              <TableRow>
          ...
          <p className="mt-3 max-w-prose text-sm leading-relaxed">
            ...
            because the new ACs are thinner terrain, but aggregate impact grew.
            BDJS held footprint steady with a small per-fielded uptick.
          </p>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead className={COMPACT_HEAD_CLASS}>Partition</TableHead>
                <TableHead className={cn(COMPACT_HEAD_CLASS, NUM_HEAD_CLASS)}>
                  n
                </TableHead>
                <TableHead className={cn(COMPACT_HEAD_CLASS, NUM_HEAD_CLASS)}>
          ...
          <p className="mt-3 max-w-prose text-sm leading-relaxed">
            This is the cleanest single piece of evidence for the concentration
            thesis. BJP's gains weren't distributed across Kerala — they
            concentrated inside the 30-seat targeted subset, while the rest of
            the state was flat-to-negative.
          </p>
          <p className="mt-3 max-w-prose text-sm leading-relaxed">
            <strong>
              Under first-past-the-post, concentrated growth can convert seats
              more effectively than thin statewide spread.
            </strong>{" "}
            BJP's 2026 looks less like a broad expansion attempt and more like a
            selective seat-conversion strategy under structural constraints.
          </p>

          {/* Subsection 4 — Per-cohort detail */}
          <h3 className={cn(SUB_HEADING, "mt-8 mb-3")}>Per-cohort detail</h3>
          <p className="mb-3 max-w-prose text-sm leading-relaxed text-muted-foreground">
            ...
            abstention/exclusion partitions. Click a cohort name to jump back to
            its detail.
          </p>
          <Table>
            <TableHeader>
          ...
          <h3 className={cn(SUB_HEADING, "mt-8 mb-3")}>Alliance arithmetic</h3>
          <p className="mb-3 max-w-prose text-sm leading-relaxed text-muted-foreground">
            Supporting detail: how the three NDA constituents added up. NDA grew
            +2.05pp statewide while BJP itself was flat — the difference came
            from T20's expansion.
          </p>
          <Table>
            <TableHeader>
              <TableRow>
            ...
            <TableBody>
              ...
              <TableRow className="bg-muted/40 font-semibold">
                <TableCell className={COMPACT_CELL_CLASS}>NDA total</TableCell>
                <TableCell className={cn(COMPACT_CELL_CLASS, NUM_CELL_CLASS)}>
        ...
        <section id="does-not-mean" className="scroll-mt-20 border-t pt-10">
          ...
          <ul className="ml-5 list-disc space-y-2 text-sm leading-relaxed sm:text-[15px]">
            <li>
              <strong>BJP is not broadly competitive statewide.</strong> Three
              wins concentrated in adjacent districts is a long way from a
              statewide presence. The flat ~+0.3pp aggregate is the truer
              statewide picture; the +5pp inside the targeted set is a
            ...
            <li>
              ...
              <SeatLink ac={101}>Poonjar</SeatLink> (+22.9pp NDA Δ) all moved
              dramatically and still lost.
            </li>
            <li>
              <strong>
                Statewide aggregates can hide intense local concentration.
              </strong>{" "}
              The same +0.30pp BJP statewide figure is consistent with both "BJP
              barely moved" and "BJP grew sharply in a small subset" — the
              cohort decomposition shows it's the second story, not the first.
            </li>
            <li>
              <strong>Demographic correlations are not causal claims.</strong>{" "}
              Hindu-heavy seats are over-represented in the wins, but the data
              is constituency-level, not voter-level. Multiple voter-level
              mechanisms are consistent with the same AC pattern (see
              methodology).
            </li>
            <li>
              <strong>
                Candidate effects and alliance-slot effects remain confounders.
              </strong>{" "}
              Marquee candidates (Rajeev Chandrasekhar, V. Muraleedharan, Shone
              George, Anoop Antony, P.C. George) plausibly contribute to the
              share movements — separating "candidate" from "demographic
              terrain" from "alliance slot" needs voter-level data we don't
              have.
            </li>
            <li>
              <strong>
              ...
              Cohort membership and the conversion threshold could move in 2031
              if base shares shift, slot allocations rotate, or the candidate
        ...
        <section className="rounded-md border bg-card/50 p-5 sm:p-6">
          ...
          <ul className="mt-3 space-y-2 text-sm leading-relaxed">
            <li>
              The 21-seat{" "}
              <CohortLink slug="wave-capture">wave-capture</CohortLink> cohort
              exists because the{" "}
              <ProseLink to="/walkthroughs/ldf-walkthrough">
                anti-LDF wave
              </ProseLink>{" "}
            ...
            <li>
              The marquee-Christian-candidate finding in mature growers (Pala,
              Thiruvalla) and the Christian-seat ceiling in declining mature
              both intersect with the{" "}
              <ProseLink to="/walkthroughs/udf-walkthrough#christian-belt">
                UDF walkthrough's Christian-belt premium
              </ProseLink>{" "}
              — Christian-heavy ACs gained UDF a robust ~3-4pp above the wave
              baseline. The two pages illuminate the same terrain from different
              angles.
            </li>
          </ul>
        </section>
        ...
        >
          ...
          <p>
            ...
            Comparing 2016/2021/2026 BJP-only shares produces misleading deltas
            when BJP didn't field but BDJS/Twenty 20 did, or when the same
            individual ran under a different party. We compute an effective NDA
            baseline at each AC for each cycle in priority order: BJP share if
            BJP fielded; same-individual share under any party (e.g. P.C. George
            at Poonjar — Independent 2016, KJS 2021, BJP 2026); BDJS share;
            Twenty 20 share; 0% otherwise. Candidate continuity is resolved via{" "}
