...
- 2026-05-07: **Original-narratives batch added** (3 new cards: ldf-shallow-distribution, vote-efficiency, anti-ldf-flow). Catalog at 11 cards. Most original work to date.
- 2026-05-07: **Polish pass complete.** Added confidence labels (Strong / Moderate / Exploratory) to all 11 cards; softened A3 "candidate-selection failure" to "consistent with weak UDF candidate performance contributing materially"; softened A8 "without Central Kerala UDF doesn't form government" to "Central Kerala provided nearly half of UDF's eventual majority margin"; added explicit contest-entry vs organic-expansion distinction in bjp-ac-growth (8 of 12 top gainers are contest-entry activations, only 3-4 are organic); created `methodology-gradient-vs-cluster.md` brief documenting the conceptual scaffolding. Verified all evidence cards have the "directly shows / does NOT prove / would weaken" trifecta. Catalog at 12 documents (11 cards + 1 methodology brief).
- 2026-05-07: **Final polish pass complete.** Three phases: (1) small wording tightening — anti-ldf-flow headline softened, synthesis "press post-mortems collapse them" softened, vote-efficiency "attributable to" rephrased as "FPTP amplified the geographic distribution"; (2) synthesis additions — new "Swing source vs seat amplification" section documenting the analytical-layer distinction, new "Kerala 2026 was not highly polarized geographically" section, new "What contradicted my prior expectations" section listing 6 findings that reversed pre-analysis priors; (3) methodology consolidation — created `methodology-core-concepts.md` covering inference boundaries / vote-share Δ accounting / KC(M) handling / FE methodology / treatment-control design / etc., and converted all 11 cards from "we/our/us" first-person-plural voice to impersonal/passive voice (123 instances → 0). Catalog at 13 documents (11 evidence cards + 2 methodology briefs).
